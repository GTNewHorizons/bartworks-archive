...
public class Centrifuge implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(new ItemStack(GT_TileEntity_THTR.THTRMaterials.aTHTR_Materials, 1, 3),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs( new ItemStack(GT_TileEntity_THTR.THTRMaterials.aTHTR_Materials, 1, 5),
                GT_Utility.getIntegratedCircuit(17))
        ...
        for (GT_TileEntity_HTGR.HTGRMaterials.Fuel_ fuel : sHTGR_Fuel) {
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(new ItemStack(GT_TileEntity_HTGR.HTGRMaterials.aHTGR_Materials, 1, i + 5),
                    GT_Utility.getIntegratedCircuit(17))
