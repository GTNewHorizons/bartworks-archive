...
public class Assembler implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                new ItemStack(ItemRegistry.BW_BLOCKS[0], 1, 0), Materials.Lapis.getPlates(9),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_ModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 1000),
                GT_Utility.getIntegratedCircuit(17))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_ModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 1002),
                GT_Utility.getIntegratedCircuit(17))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_ModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 1126),
                GT_Utility.getIntegratedCircuit(17))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_ModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 1169),
                GT_Utility.getIntegratedCircuit(17))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_ModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 1160),
                GT_Utility.getIntegratedCircuit(17))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.AnnealedCopper, 64L),
                GT_Utility.getIntegratedCircuit(17))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs( GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 1L),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(ItemList.Circuit_Parts_GlassFiber.get(32),
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Lead, 6),
