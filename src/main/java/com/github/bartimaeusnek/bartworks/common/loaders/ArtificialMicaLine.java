...
public class ArtificialMicaLine {
    ...
    public static void runArtificialMicaRecipe() {
        ...
        //2Al + 3O = Al2O3
        GT_Values.RA.addChemicalRecipe(Materials.Aluminium.getDust(2), GT_Utility.getIntegratedCircuit(5), Materials.Oxygen.getGas(3000), null, WerkstoffLoader.Alumina.get(OrePrefixes.dust, 1), 10, 8);
        //2K + CO2 + O = 6K2CO3
